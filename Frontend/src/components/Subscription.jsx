          ...
          <Row>
            <Col md={3} className="">
              <div className="Subscriptioncard2">
                ...
                />
                <br />
                SkillSwap was truly a game-changer and a great guide for me as
            ...
            <Col md={3} className="">
              <div className="Subscriptioncard2">
                ...
                exactly what I needed to know in the real world. It helped me
                sell myself to get a new role.
                <br />
                <br />
                <hr className="Subscriptioncustom-hr4" />
                <Row>
                  ...
                  <Col md={9} className="Subscriptionimg3description">
                    <span className="Subscriptionimg3description">
                      William A. Wachlin Partner Account Manager at Amazon Web
                      Services
                    </span>
                    <br />
                    <span className="Subscriptionimg3description"></span>
            ...
            <Col md={3} className="">
              <div className="Subscriptioncard2">
                ...
                <Row>
                  ...
                  <Col md={9} className="Subscriptionimg3description">
                    <span className="Subscriptionimg3description">
                      Ian Stevens Head of Capability Development, North America
                      at Publicis Sapient
                    </span>
                    <br />
                    <span className="Subscriptionimg3description"></span>
